...
// --- CONFIG WiFi ---
const char* ssid = "Moto-wifi";
const char* password = "12345678";

// --- CONFIG MQTT ---
const char* mqtt_server = "10.190.108.134"; // IP MQTT SERVER
...
// ---------- Umbrales ----------
const int   UMBRAL_SOIL_RAW = 800;     // humedad (raw)
const int   UMBRAL_TILT_OK  = 1;       // tilt esperado
...
void interpretarYProcesar(const String &json) {
  ...
  bool alerta = (avgTilt != UMBRAL_TILT_OK) || (avgVib != UMBRAL_VIB_HIT) || (avgSoil >= UMBRAL_SOIL_RAW);

  // --- Accionar alarma ---
  if (alerta) {
    Serial.println(F("[ALERTA] UMBRAL SUPERADO - BUZZER ON"));
